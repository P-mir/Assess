...
def explain(x, model,task, path = "outputs/plots/mlflow_artifacts/shap"):
...
#                                      title='Impact of the {} variable on the prediction of {}'.format(feature,model.classes_),
#                                      show=False)
#                     plt.savefig("{}/dependance_plots/{}_{}_dependance_plot.png".format(path, model.classes_,feature),dpi=150, bbox_inches='tight')
#                     plt.clf()
        ## Interaction plots
